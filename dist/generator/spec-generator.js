...
export class SpecGenerator {
    ...
    async applyLLMPolish(entity, factSets, templateDraft) {
        ...
        let promptKey = 'O';
        const maxAttempts = 3;
        const guidance = []; // Accumulate validation failures for retry guidance
