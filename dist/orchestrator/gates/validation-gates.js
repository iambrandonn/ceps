 ...
 */
export class CostGateEvaluator {
    fixtureThresholds = {
        'express-api': 30000,
        'react-app': 40000,
    ...
    evaluate(input) {
        ...
        if (input.perFixture) {
            for (const [fixture, usage] of Object.entries(input.perFixture)) {
                ...
                if (threshold && usage > threshold) {
                    fixtureViolations.push(`${fixture}: ${usage} tokens (threshold: ${threshold})`);
                }
            }
        }
        ...
        return {
            ...
            details: failed
                ? {
                    overBudget,
                    fixtureViolations: fixtureViolations.length > 0 ? fixtureViolations : undefined
                }
                : undefined
        };
    }
...
//# sourceMappingURL=validation-gates.js.map