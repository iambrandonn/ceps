...
import { renderJSON, renderConsole, validateRunSummary } from '../rendering/run-summary-renderer.js';
...
describe('Run Summary Renderer', () => {
    ...
    describe('Schema Validation', () => {
        ...
        it('should reject summary with missing required fields', () => {
            ...
            expect(() => validateRunSummary(invalidSummary)).toThrow('Run summary validation failed');
        });
...
//# sourceMappingURL=run-summary-renderer.test.js.map