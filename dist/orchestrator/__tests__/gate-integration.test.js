 ...
 */
function createCoverageFailureInputs() {
    const inputs = createAllPassInputs();
    inputs.coverage = {
        exportedEntityIds: ['e1', 'e2', 'e3'],
 ...
 */
function createLinkFailureInputs() {
    const inputs = createAllPassInputs();
    inputs.link = {
        totalAnchors: 100,
        brokenLinks: [
 ...
 */
function createGroundingFailureInputs() {
    const inputs = createAllPassInputs();
    inputs.grounding = {
        totalChunks: 150,
        validatedChunks: 100,
 ...
 */
function createMultipleRuntimeFailuresInputs() {
    const inputs = createAllPassInputs();
    inputs.coverage = {
        exportedEntityIds: ['e1', 'e2', 'e3'],
        entitiesWithChunks: ['e1'],
 ...
 */
function createCostFailureInputs() {
    const inputs = createAllPassInputs();
 ...
 */
function createAdversarialFailureInputs() {
    const inputs = createAllPassInputs();
 ...
 */
function createTestCoverageFailureInputs() {
    const inputs = createAllPassInputs();
 ...
 */
function createTestCoverageAndRuntimeFailureInputs() {
    const inputs = createAllPassInputs();
 ...
 */
function createReadabilityFailureInputs() {
    const inputs = createAllPassInputs();
    inputs.readability = {
        avgScore: 4.5,
        threshold: 7.0
 ...
 */
function createMixedFailuresInputs() {
    const inputs = createAllPassInputs();
 ...
 */
function createSkippedGatesInputs() {
    const inputs = createAllPassInputs();
    inputs.determinism = {
        enabled: false,
        reruns: 0,
...
//# sourceMappingURL=gate-integration.test.js.map