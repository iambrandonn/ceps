 ...
 */
export function renderDiagnostics(diagnostics, options) {
 ...
 */
function stripNonDeterministicValues(diagnostic) {
 ...
 * @returns JSON string
 */
function renderJSON(diagnostics) {
 ...
 * @returns Text string
 */
function renderText(diagnostics) {
    const lines = [];
