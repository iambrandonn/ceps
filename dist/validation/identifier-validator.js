...
export class IdentifierValidator {
     ...
     */
    validate(identifiers, factSetIds) {
        const diagnostics = [];
     ...
     */
    validateRelations(subjectEntityId, targetIdentifiers, factSetIds) {
        const diagnostics = [];
     ...
     */
    extractIdentifiersFromSentence(sentence) {
        const identifiers = [];
        // PascalCase pattern
     ...
     */
    findEntityInScope(entityIds, factSetIds) {
