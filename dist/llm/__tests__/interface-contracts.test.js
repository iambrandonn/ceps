...
describe('LLM Gateway Interface Contracts (CTS-02 §6)', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(gateway, 'completions').mockResolvedValue('This is a mocked LLM response describing the behavior.');
    ...
    describe('validate() integration', () => {
        ...
        it('should handle retry outcome from validator', () => {
            ...
            const result = mockValidator.validate('UserService validates input.', ['fs-1'], {
                chunkId: 'chunk-1',
                targetEntityId: 'entity-1',
                factSetIds: ['fs-1'],
                confidence: 'High',
        ...
        it('should handle fallback outcome from validator', () => {
            ...
            const result = mockValidator.validate('Process completes in 6 seconds.', ['fs-1'], {
                chunkId: 'chunk-1',
                targetEntityId: 'entity-1',
                factSetIds: ['fs-1'],
                confidence: 'Medium',
    ...
    describe('CTS interface delegation', () => {
        it('should call underlying provider adapter for summarize', async () => {
            ...
            const spy = vi.spyOn(gateway, 'completions');
            const factSets = [
                {
                    id: 'fs-1',
...
//# sourceMappingURL=interface-contracts.test.js.map