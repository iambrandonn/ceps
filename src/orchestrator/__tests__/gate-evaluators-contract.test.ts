...
} from '../mocks/mock-gate-evaluators.js';

describe('Gate Evaluator Contracts', () => {
  describe('MockCoverageGateEvaluator', () => {
    let evaluator: MockCoverageGateEvaluator;
  ...
  describe('MockLinkGateEvaluator', () => {
    let evaluator: MockLinkGateEvaluator;
  ...
  describe('MockGroundingGateEvaluator', () => {
    let evaluator: MockGroundingGateEvaluator;
  ...
  describe('MockDeterminismGateEvaluator', () => {
    let evaluator: MockDeterminismGateEvaluator;
  ...
  describe('MockConfidenceGateEvaluator', () => {
    let evaluator: MockConfidenceGateEvaluator;
  ...
  describe('MockMonorepoGateEvaluator', () => {
    let evaluator: MockMonorepoGateEvaluator;
  ...
  describe('MockCostGateEvaluator', () => {
    let evaluator: MockCostGateEvaluator;
  ...
  describe('MockAdversarialGateEvaluator', () => {
    let evaluator: MockAdversarialGateEvaluator;
  ...
  describe('MockTestCoverageGateEvaluator', () => {
    let evaluator: MockTestCoverageGateEvaluator;
  ...
  describe('MockReadabilityGateEvaluator', () => {
    let evaluator: MockReadabilityGateEvaluator;
